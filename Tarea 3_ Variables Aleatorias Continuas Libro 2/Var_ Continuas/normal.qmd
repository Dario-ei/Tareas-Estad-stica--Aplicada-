...
ggplot(dist_altura) +
  ...
  geom_area(data = dist_altura |> filter(estaturas >= 180),
            aes(estaturas, pdf_altura), fill = "firebrick", alpha = 0.5) +
...
ggplot(datos, aes(x = mes, y = ventas)) +
  ...
  geom_hline(yintercept = 45000, linetype = "dashed", color = "firebrick") +
  annotate("text", x = 2, y = 45500, label = "Meta: 45,000", color = "firebrick", hjust = 0) +
...
ggplot(datos, aes(x = error)) +
  ...
  annotate("text", x = -3, y = 0.00001, label = "-3/+3", color = "purple", hjust = 1.2) +
...
ggplot(datos_long, aes(x = Puntaje, fill = Grupo)) +
  geom_histogram(aes(y = ..density..), bins = 20, alpha = 0.5, position = "identity", color = "black") +
  stat_function(fun = dnorm, args = list(mean = mu_A, sd = sigma_A), color = "blue", linewidth = 1.2) +
  stat_function(fun = dnorm, args = list(mean = mu_B, sd = sigma_B), color = "red", linewidth = 1.2) +
  geom_vline(xintercept = c(percentil_90_A, percentil_90_B), linetype = "dashed", color = c("blue","red")) +
  annotate("text", x = percentil_90_A+1, y = 0.015, label = "10% Sup A", color = "blue") +
  annotate("text", x = percentil_90_B+1, y = 0.015, label = "10% Sup B", color = "red") +
